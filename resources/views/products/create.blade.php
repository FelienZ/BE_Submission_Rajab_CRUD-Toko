        ...
        <div class="col-md-10">
            <div class="card border-0 shadow-lg my-4">
                <div class="card-header bg-dark">
                    <h3 class="text-white">Jual Barang</h3>
                </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input value="{{old('name')}}" type="text" class="{{ $errors->has('name') ? 'is-invalid' : '' }} form-control form-control-lg" placeholder="Name" name="name">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{old('price')}}" type="text" class="{{ $errors->has('price') ? 'is-invalid' : '' }} form-control form-control-lg" placeholder="Price" name="price">
                        @error('price')
                        <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="desc" placeholder="Desc" cols="30" rows="5">{{old('desc')}}</textarea>
                    </div>
                    <div class="mb-3">
