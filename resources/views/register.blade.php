...
<html lang="en">
    <head>
        ...
        <title>Web Toko Online - Register</title>
                                ...
                                <form action="{{route('account.processRegister')}}" method="POST">
                                    ...
                                    <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Username" >
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-dark py-3" type="submit">Register</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{route('account.login')}}" class="link-dark text-decoration-none">Punya Akun? login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
