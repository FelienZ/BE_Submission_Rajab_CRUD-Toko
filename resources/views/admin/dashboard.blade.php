...
<html lang="en">
   ...
   <body class="bg-light">
        <nav class="navbar navbar-expand-md bg-dark shadow-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret">
            <div class="container">
                <a class="navbar-brand text-white" href="#">
                   <strong>Web Toko Online</strong>
                </a>
        ...
        <div class="container">
           <div class="card border-0 shadow my-5">
                <div class="card-header bg-dark">
                    <h3 class="h5 pt-2 text-white">Dashboard</h3>
                </div>
                <div class="card-body">
                    You are logged in !!
                </div>
